...
<head>
    <meta charset="UTF-8">
    <title>Ingresos | Conta Tech</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="tabs">
                <button class="tab active"><a href="ingresos.php">Ingresos</a></button>
                <button class="tab"><a href="gastos.php">Gastos</a></button>
            </div>
        </div>
        <form>
            <table>
                ...
                <tbody>
                    <?php
                    include("../../config/conexion.php");
                    $query = "SELECT * FROM ingresos"; // Cambia 'inventario' por el nombre de tu tabla
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                <a href='actualizarIngreso.php?cod={$row['id_ingreso']}'>Actualizar</a>
                                <br>
                                <a href='eliminarIngreso.php?cod={$row['id_ingreso']}'>Eliminar</a></td>";
                            echo "</tr>";
                        }
                    } else {
            ...
            <!-- Botones --> 
            <div class="botones">
                <button><a href="../gastos_ingresos/gasto_ingreso.php">Agregar Ingreso</a></button>
            </div>
        </form>
  </div>
