...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="tabs">
                <button class="tab"><a href="listaProductos.php">Lista de Productos</a></button>
                <button class="tab active"><a href="alertasStock.php">Alerta de Stock</a></button>
            </div>
        ...
        <form>
            <table>
                ...
                <tbody>
                    <?php
                    include("../../config/conexion.php");
                    $query = "SELECT * FROM productos WHERE cantidad <= 3"; // Cambia 'inventario' por el nombre de tu tabla
